...
#  print(os.getcwd())
  ...
  "rrbs_pipeline.genome_dir_tar" : "gs://***REMOVED***/rrbs/genomes/rat/rat_Bisulfite_Genome.tar.gz",\
  "rrbs_pipeline.genome_dir": "rat",\
  "rrbs_pipeline.bowtie2_phix.genome_dir" : "phix",\
  "rrbs_pipeline.bowtie2_phix.genome_dir_tar": "gs://***REMOVED***/references/rn/bowtie2_index/phix.tar.gz",\
  "rrbs_pipeline.spike_in_genome_tar": "gs://***REMOVED***/rrbs/genomes/lambda/lambda_Bisulfite_Genome.tar.gz",\
  "rrbs_pipeline.spike_in_genome_dir": "lambda",\
  "rrbs_pipeline.num_threads" : "6",\
  "rrbs_pipeline.num_preempt" : "0",\
  "rrbs_pipeline.memory" : "40",\
  "rrbs_pipeline.docker" : "gcr.io/***REMOVED***/motrpac_rrbs:araja_07_09_2019",\
